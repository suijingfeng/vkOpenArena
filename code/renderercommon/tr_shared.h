...
static inline void VectorCross(const float v1[3], const float v2[3], float cross[3] )
{
...
//note: out = A X B
static inline void MatrixMultiply4x4(const float* A, const float* B, float* out)
{
