...
/*
================
Con_CheckResize: If the line width has changed, reformat the buffer.
================
*/
...
void CL_ConsolePrint( char *txt )
{
	...
	unsigned short color = ColorIndex(COLOR_WHITE);
...
/*
================
Con_DrawInput: Draw the editline after a ] prompt
================
*/
