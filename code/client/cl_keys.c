...
/*
===================
CL_KeyDownEvent: Called by CL_KeyEvent to handle a keypress
===================
*/
void CL_KeyDownEvent( int key, unsigned int time )
{
	keys[key].down = qtrue;
	keys[key].repeats++;
...
/*
================
CL_LoadConsoleHistory: Load the console history from cl_consoleHistory
================
*/
